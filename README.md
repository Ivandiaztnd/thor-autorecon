...
- **THOR-AI-Engine** — AI-assisted autonomous pentest framework powered by local LLMs via Ollama (xxx3, xxx4, dxxxxxn). Zero cloud dependency, runs on any hardware. *(Closed Product)*
